<div class="p-4">
    <div class="flex items-center justify-between mb-4">
        ...
        <div class="flex space-x-2">
            <selectwire:model.live.debounce.500ms="selectedFilter" class="border rounded-lg px-3 py-2">
                ...
                <selectwire:model.live.debounce.500ms="month" class="border rounded-lg px-3 py-2">
                    @foreach (range(1, 12) as $m)
                    <option value="{{ $m }}">{{ date('F', mktime(0, 0, 0, $m, 1)) }}</option>
                    @endforeach
                    </select>
                    <selectwire:model.live.debounce.500ms="year" class="border rounded-lg px-3 py-2">
        ...
        <tbody>
            ...
            <tr class="text-sm {{ $loop->even }}">
                ...
                <td class="border border-gray-300 px-4 py-2">
                    ...
                    {{-- @dump($day['date_strtotime'], $peminjaman->tanggal_peminjaman, $day['date_strtotime'] ==
