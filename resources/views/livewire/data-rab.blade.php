        ...
        <div class="flex items-center gap-4">
            <div class="flex gap-4">
                ...
                <selectwire:model.live.debounce.500ms="status" class="border rounded-lg px-4 py-2 w-40">
                    ...
                    <selectwire:model.live.debounce.500ms="tahun" class="border rounded-lg px-3 py-2 w-32">
                ...
                <div class="p-6 border-b border-gray-100">
                    <div class="flex justify-between items-center">
                        <div class="relative max-w-md">
                            <input type="text" wire:model.live.debounce.500ms="searchSpb"
                                placeholder="Cari berdasarkan nomor SPB..."
