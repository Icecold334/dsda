<div x-data="{ open: @entangle('open') }" @click.away="open = false" class="relative w-full">
    <input type="text"
        ...
        placeholder="Cari..." wire:model.live.debounce.300ms="search" @focus="open = true" @click.away="open = false" />
