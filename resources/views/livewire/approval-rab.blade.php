<div>
    <div class="flex w-full justify-evenly border-t-4 py-6">
        <!-- Penulis -->
        <div>
            <div class="block font-semibold text-center mb-2 text-gray-900">Perencanaan</div>
        ...
        <div>
            <div class="block font-semibold text-center mb-2 text-gray-900">
                {{ ucwords(str_replace('-', ' ', $roleKey)) }}{{ $roleKey == 'kepala-seksi' ? ' Perencanaan' : '' }}
            </div>
...
<script>
    function confirmApprove() {
                Swal.fire({
                    ...
                    text: 'Apakah Anda yakin ingin menyetujui RAB ini?',
                    icon: 'warning',
