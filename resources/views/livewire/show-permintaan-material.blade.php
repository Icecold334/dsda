    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <x-card title="data umum" class="mb-3">
                ...
                <div class="flex items-center justify-between border-b-4 p-2 rounded my-1">
                    <span class="flex items-center space-x-3">
                        ...
                        <span>
                            <a href="{{ Storage::disk('gcs')->url('lampiranMaterial/' . $attachment->path) }}"
        ...
        <div class="mt-3 max-h-52 overflow-auto">
            ...
            <div class="flex items-center justify-between border-b-4 p-2 rounded my-1">
                ...
                @if(auth()->user()->hasRole('Pengurus Barang') && $permintaan->status == 2 && isset($showEditFoto) &&
                $showEditFoto)
...
<div class="mb-6">
    ...
    <x-card title="Tanda Tangan Driver & Keamanan">
        ...
        @if(auth()->user()->hasRole('Pengurus Barang') && $permintaan->status == 2 && $permintaan->driver &&
        $permintaan->security && $permintaan->nopol)
