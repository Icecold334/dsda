<div>
    <table class="w-full border-0 border-separate border-spacing-y-4">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" id="petugas" wire:model.live.debounce.500ms="petugas"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    ...
    <div class="flex justify-end">
        @if ($id)
        <button type="button"
            onclick="confirmRemove('Apakah Anda yakin ingin menghapus Toko ini?', () => @this.call('removeToko'))"
