                ...
                <div class="bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
                    ...
                    <form wire:submit.prevent="save">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" wire:model.live.debounce.500ms="modalData.tanggal"
                        ...
                        <div class="mb-4">
                            ...
                            {{-- <input type="text" id="person" wire:model.live.debounce.500ms="person"
                                ...
                                placeholder="Masukkan Penanggung Jawab" wire:blur="hideSuggestionsPerson" required>
                            ...
                            @endif --}}
                            <input type="text" wire:model.live.debounce.500ms="person"
                                wire:input="fetchSuggestions('person', $event.target.value)"
                                class="w-full border rounded-lg px-3 py-2 focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                                placeholder="Masukkan Penanggung Jawab" wire:blur="hideSuggestions('person')" required>
                        ...
                        <div class="mb-4">
                            ...
                            @endif --}}
                            <input type="text" wire:model.live.debounce.500ms="lokasi"
                        ...
                        <div class="mb-4 grid grid-cols-3 gap-4">
                            <div>
                                ...
                                <div class="flex items-center">
                                    <input type="number" wire:model.live.debounce.500ms="modalData.jumlah"
                            ...
                            <div>
                                ...
                                <input type="number" wire:model.live.debounce.500ms="modalData.kondisi"
                                    class="border rounded-lg px-3 py-2 w-full">
                            ...
                            <div>
                                ...
                                <input type="number" wire:model.live.debounce.500ms="modalData.kelengkapan"
                                    class="border rounded-lg px-3 py-2 w-full">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" wire:model.live.debounce.500ms="modalData.keterangan"
                                class="w-full border rounded-lg px-3 py-2">
                        ...
                        <div class="mb-4">
                            ...
                            <selectwire:model.live.debounce.500ms="modalData.tipe"
                                class="w-full border rounded-lg px-3 py-2">
                        ...
                        <div class="mb-4">
                            ...
                            <selectwire:model.live.debounce.500ms="modalData.hari"
                                class="w-full border rounded-lg px-3 py-2">
                        ...
                        <div class="mb-4">
                            ...
                            <selectwire:model.live.debounce.500ms="modalData.hari"
                                ...
                                @for ($i = 1; $i <= $maxDays; $i++) <option value="{{ $i }}">{{ $i }}</option>
                                    @endfor
                                    </select>
                                    @error('modalData.hari')
                                    <span class="text-red-500 text-sm">{{ $message }}</span>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex space-x-2">
                                <selectwire:model.live.debounce.500ms="modalData.bulan"
                                    class="w-full border rounded-lg px-3 py-2">
                                    ...
                                    @for ($i = 1; $i <= 12; $i++) <option value="{{ $i }}">
                                        ...
                                        <selectwire:model.live.debounce.500ms="modalData.hari"
                                            class="w-full border rounded-lg px-3 py-2">
                                            <option value="">Pilih Tanggal</option>
                                            @for ($i = 1; $i <= $maxDays; $i++) <option value="{{ $i }}">{{ $i }}
                                                </option>
                                                @endfor
                                                </select>
                                                @error('modalData.hari')
                        ...
                        <div class="mb-4">
                            ...
                            <textareawire:model.live.debounce.500ms="modalData.keterangan" rows="3"
                                class="w-full border rounded-lg px-3 py-2"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" wire:model.live.debounce.500ms="modalData.nominal"
