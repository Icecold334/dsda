<div>
    <div class="flex justify-between py-2 mb-3">
        ...
        <div class="flex gap-4">
            <input type="date" wire:model.live.debounce.500ms="tanggal" class="border rounded-lg px-4 py-2" />
            <input type="text" wire:model.live.debounce.500ms="search" class="border rounded-lg px-4 py-2"
            ...
            <selectwire:model.live.debounce.500ms="jenis"
                ...
                <selectwire:model.live.debounce.500ms="metode" class="border rounded-lg px-4 py-2">
