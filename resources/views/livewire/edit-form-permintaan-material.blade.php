<div>
    ...
    <div class=<td>
        <selectwire:model.live.debounce.500ms="gudang_id" @disabled($permintaan->status !== 4 || $rab)
                ...
                <form wire:submit.prevent="{{ $permintaan->status === 4 ? 'updateData' : '' }}">
                    <table class="w-full border-separate border-spacing-y-4">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" wire:model.live.debounce.500ms="nodin" @disabled($permintaan->status
                                !== 4) class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                        ...
                        <tr>
                            ...
                            <td>
                                <selectwire:model.live.debounce.500ms="gudang_id" @disabled($permintaan->status !== 4 ||
                                    $rab)
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" wire:model.live.debounce.500ms="jenisPekerjaan"
                        ...
                        <tr>
                            ...
                            <td>
                                <select wire:model.live.debounce.500ms="kecamatan_id" @disabled($permintaan->status !==
                                    4 || $isKasatpel)
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                    focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <selectwire:model.live.debounce.500ms="kelurahan_id" @disabled($permintaan->status !==
                                    4)
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                    focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5
                                    @if($permintaan->status !== 4) cursor-not-allowed opacity-50 @endif">
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <input type="text" wire:model.live.debounce.500ms="lokasiMaterial"
                                    @disabled($permintaan->status !== 4)
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5
                                @if($permintaan->status !== 4) cursor-not-allowed opacity-50 @endif"
                            ...
                            <td>
                                <div class="grid grid-cols-3 gap-2">
                                    <div>
                                        ...
                                        <input type="number" step="0.01" wire:model.live.debounce.500ms="p"
                                            @disabled($permintaan->status !== 4)
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                        focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5
                                        @if($permintaan->status !== 4) cursor-not-allowed opacity-50 @endif"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" wire:model.live.debounce.500ms="l"
                                            @disabled($permintaan->status !== 4)
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                        focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5
                                        @if($permintaan->status !== 4) cursor-not-allowed opacity-50 @endif"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" step="0.01" wire:model.live.debounce.500ms="k"
                                            @disabled($permintaan->status !== 4)
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                        focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5
                                        @if($permintaan->status !== 4) cursor-not-allowed opacity-50 @endif"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="date" wire:model.live.debounce.500ms="tanggal_permintaan"
                                    @disabled($permintaan->status !== 4) class="bg-gray-50 border border-gray-300
                        ...
                        <tr>
                            ...
                            <td>
                                <textareawire:model.live.debounce.500ms="keterangan" @disabled($permintaan->status !==
                                    4) rows="3"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                    focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5
                                    @if($permintaan->status !== 4) cursor-not-allowed opacity-50 @endif"
        ...
        <x-card title="Daftar Item Permintaan">
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div class="flex items-end w-full gap-4">
                    <div class="flex flex-col w-full">
                        ...
                        <selectwire:model.live.debounce.500ms="newBarangId"
                            ...
                            @else
                            <livewire:searchable-selectwire:model.live.debounce.500ms="newBarangId" :options="$barangs"
                                label="nama" />
                            @endif
                    </div>
                    <div class="flex flex-col w-full">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Merk/Spesifikasi</label>
                        <selectwire:model.live.debounce.500ms="newMerkId" @disabled(!$newBarangId) class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <div class="flex">
                            <input type="number" wire:model.live.debounce.500ms="newJumlah" @disabled(!$newMerkId)
                ...
                <div class="mt-3">
                    ...
                    <selectwire:model.live.debounce.500ms="newRabId"
                        class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                ...
                <table class="w-full border-3 border-separate border-spacing-y-2">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-gray-50 hover:bg-gray-200 hover:shadow-lg transition duration-200 rounded-2xl">
                            ...
                            <td class="py-3 px-6">
                                <select disabled
                                    ...
                                    <option value="{{ $item['rab_id'] }}">
                                        {{ $availableRabs->firstWhere('id', $item['rab_id'])->jenis_pekerjaan ?? 'RAB
                                        tidak ditemukan' }}
                                    </option>
                                </select>
                            </td>
                            ...
                            <td class="py-3 px-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="w-full">
                                        <div class="flex">
                                            <input type="number"
                                                wire:model.live.debounce.500ms="list.{{ $index }}.jumlah" min="1"
                            ...
                            <td class="py-3 px-6">
                                @if($permintaan->status === 4)
                                <textareawire:model.live.debounce.500ms="list.{{ $index }}.keterangan" rows="2"
                                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
