<div>
    <div class="flex justify-between py-1 mb-3">
        ...
        <div class="flex gap-4 ">
            <input type="date" wire:model.live.debounce.500ms="tanggal" class="border rounded-lg px-4 py-2 w-full" />
            ...
            <selectwire:model.live.debounce.500ms="jenis" class="border rounded-lg px-4 py-2 w-full">
            ...
            <tr class="bg-gray-50 hover:bg-gray-200 hover:shadow-lg transition duration-200 rounded-2xl">
                ...
                <td class="py-3 px-6 text-center">
                    <div class="flex items-center justify-center gap-2">
                        ...
                        <div id="tooltip-edit-{{ $datang->id }}" role="tooltip"
                        ...
                        <form action="{{ route('pengiriman-stok.destroy', $datang->id) }}" method="POST">
                            ...
                            <button type="submit" onclick="confirmDelete(event)"
                                class="text-red-500 px-3 py-2 rounded-md border hover:bg-slate-200"
                                data-tooltip-target="tooltip-delete-{{ $datang->id }}">
                                <i class="fa-solid fa-trash"></i>
                            </button>
                        </form>
                        <div id="tooltip-delete-{{ $datang->id }}" role="tooltip"
                            class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip">
                            Hapus Data
                        </div>
                        @endcan
