                ...
                <tr class="bg-gray-50 hover:bg-gray-200 hover:shadow-lg transition duration-200 rounded-2xl">
                    ...
                    <td class="px-6 py-3 text-center">
                        <div class="relative inline-block">
                            ...
                            <input type="file" wire:model.live="list.{{ $index }}.img_done" class="hidden"
                                id="upload-list.{{ $index }}.img_done">
                            @php
                            $isPenjagaGudang = auth()->user()?->hasRole('Penjaga Gudang');
                            $isStatusAktif = $item['detail_permintaan_status'];
                    ...
                    <td class="px-6 py-3 text-center">
                        <div class="relative inline-block">
                            ...
                            <input type="text" wire:model.live="list.{{ $index }}.voucher_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 focus:ring-blue-500 focus:border-blue-500
