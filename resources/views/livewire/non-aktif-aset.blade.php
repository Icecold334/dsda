    ...
    <form wire:submit.prevent="save">
        <x-card title="Edit Data Non-Aktif" class="mb-3">
            {{-- <div class="mb-4">
                ...
                <selectwire:model.live.debounce.500ms="status"
            ...
            <div class="mb-4">
                ...
                <input type="date" wire:model.live.debounce.500ms="tglnonaktif"
                    class="w-full border rounded-lg px-3 py-2 mt-1 focus:outline-none focus:ring focus:ring-primary-300">
                @error('tglnonaktif')
            ...
            <div class="mb-4">
                ...
                <selectwire:model.live.debounce.500ms="alasannonaktif"
                    class="w-full border rounded-lg px-3 py-2 mt-1 focus:outline-none focus:ring focus:ring-primary-300">
            ...
            <div class="mb-4">
                ...
                <textareawire:model.live.debounce.500ms="ketnonaktif" rows="3"
                    class="w-full border rounded-lg px-3 py-2 mt-1 focus:outline-none focus:ring focus:ring-primary-300">
                    </textarea>
                    @error('ketnonaktif')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
