                ...
                <form wire:submit.prevent="fetchAsets">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <selectwire:model.live.debounce.500ms="merk_id" class="border p-2 rounded w-full">
                        ...
                        <div>
                            ...
                            <selectwire:model.live.debounce.500ms="toko_id" class="border p-2 rounded w-full">
                        ...
                        <div>
                            ...
                            <selectwire:model.live.debounce.500ms="penanggung_jawab_id"
                        ...
                        <div>
                            ...
                            <selectwire:model.live.debounce.500ms="lokasi_id" class="border p-2 rounded w-full">
