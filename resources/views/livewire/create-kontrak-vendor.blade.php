                ...
                <x-card title="Informasi Kontrak">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model.live="{{ $field }}" {{ $readonly_fields && !$mode_manual
                        ...
                        <div>
                            ...
                            <input type="date" wire:model.live="tanggal_akhir_kontrak" {{ $readonly_fields &&
                ...
                init() {
                    ...
                    this.$watch('$wire.newHarga', (value) => {
                        ...
                        <div>
                            ...
                            <livewire:searchable-select wire:model.live="specifications.nama"
                                :options="$specNamaOptions" placeholder="Ketik atau pilih nama..." />
                        </div>

                        <div>
                            <label class="block text-sm font-medium">Tipe</label>
                            <livewire:searchable-select wire:model.live="specifications.tipe"
                ...
                <table class="min-w-full text-sm border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="p-2 text-center">{{ $item['ppn'] == 0 ? 'Termasuk PPN' : $item['ppn'] . '%' }}
                            </td>
