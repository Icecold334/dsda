<div x-data="signatureHandler">
    <table class="w-full border-0 border-separate border-spacing-y-4">
        ...
        <tr>
            ...
            <td>
                <input type="text" id="nip" wire:model.live.debounce.500ms="nip"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        {{-- <tr>
            ...
            <td>
                @dump($lokasi_stok)
                @dump($errors->first())
                <select id="lokasi_stok" wire:model.live.debounce.500ms="lokasi_stok"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required>
        ...
        <tr>
            ...
            <td>
                @dump($unit_kerja)
                <select id="unit_kerja" wire:model.live.debounce.500ms="unit_kerja"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    required>
        ...
        {{-- <tr>
            ...
            <td>
                <input type="text" id="perusahaan" wire:model.live.debounce.500ms="perusahaan"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <tr>
            ...
            <td>
                <textarea id="alamat" wire:model.live.debounce.500ms="alamat"
        ...
        <tr>
            ...
            <td>
                <input type="text" id="provinsi" wire:model.live.debounce.500ms="provinsi"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <tr>
            ...
            <td>
                <input type="text" id="kota" wire:model.live.debounce.500ms="kota"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" id="new_wa" wire:model.live.debounce.500ms="new_wa"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" id="new_email" wire:model.live.debounce.500ms="new_email"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ...
        <tr>
            ...
            <td>
                ...
                <input type="password" id="old_password" wire:model.live.debounce.500ms="old_password"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="" required />
                @error('old_password')
                <span class="text-sm text-red-500 font-semibold">{{ $message }}</span>
                ...
                <div>
                    ...
                    <div class="flex items-center mb-2">
                        <input type="checkbox" id="role_{{ $role->id }}" value="{{ $role->name }}"
                            wire:model.live.debounce.500ms="selectedRoles"
    ...
    <div class="flex justify-end">
        ...
        <button type="button"
            ...
            data-tooltip-target="tooltip-delete-{{ $id }}"><i class="fa-solid fa-trash"></i></button>
        ...
        @endif
        @endif
        <button type="button" @if ($tipe=='profile' && empty($ttd)) @click="generateTTD" @else wire:click="saveProfil"
            @endif
