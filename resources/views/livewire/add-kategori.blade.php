<div>
    ...
    <div class="flex justify-end">
        @if ($id)
            <button type="button" onclick="confirmRemove('Apakah Anda yakin ingin menghapus Kategori ini?', () => @this.call('removeKategori'))"
