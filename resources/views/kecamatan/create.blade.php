<x-body>
    <div class="flex justify-between py-2 mb-3">
        <h1 class="text-2xl font-bold text-primary-900">Tambah Kecamatan</h1>
        <div>
            ...
            <form action="{{ route('kecamatan.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <x-text-input id="kecamatan" name="kecamatan" type="text" class="mt-2 block w-full"
                        value="{{ old('kecamatan') }}" required autofocus />
                ...
                <div class="mb-6">
                    ...
                    <select id="unit_id" name="unit_id"
                        ...
                        @foreach ($unitKerjas as $unitKerja)
                            <option value="{{ $unitKerja->id }}" {{ old('unit_id') == $unitKerja->id ? 'selected' : '' }}>
                                {{ $unitKerja->nama }}
                            </option>
                        @endforeach
                    </select>
