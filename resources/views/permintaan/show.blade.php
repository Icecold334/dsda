    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">
                    ...
                    <tr>
                        ...
                        <td>Harap menjaga kebersihan KDO dan memastikan tidak ada sampah yang tertinggal di
                            dalam
                            mobil.</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="pl-4 align-top text-right">1.</td>
                        <td>Peminjaman ruang rapat bidang via form, hanya untuk peminjaman lintas bidang/unit.
                        </td>
                    </tr>
                    <tr>
                        <td class="pl-4 align-top text-right">2.</td>
                    ...
                    <tr>
                        <td class="pl-4 align-top text-right">1.</td>
                        <td>Pemesan wajib menyiapkan administrasi kelengkapan SPJ (absensi asli, notulen asli
                            dan
                            foto kegiatan)
                    ...
                    <tr>
                        <td class="pl-4 align-top text-right">2.</td>
                        <td>Apabila administrasi SPJ lewat dari 2 (dua) hari, maka permintaan selanjutnya tidak
                            bisa
                            diproses
                    ...
                    <tr>
                        ...
                        <td>Setelah selesai cuci mobil harap serahkan Bon dari Carwash ke CS Umum atau Insan.
                        </td>
                    </tr>
                    @endif
                    @if (
