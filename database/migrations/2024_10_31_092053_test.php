...
return new class extends Migration
{
    public function up()
    {
        Schema::create('agenda', function (Blueprint $table) {
            ...
            $table->bigInteger('hari')->default(0);
            $table->bigInteger('tanggal')->default(0);
            $table->bigInteger('bulan')->default(0);
        ...
        Schema::create('aset', function (Blueprint $table) {
            ...
            $table->bigInteger('tanggalbeli')->default(0);
            ...
            $table->bigInteger('umur')->default(0);
            $table->decimal('penyusutan', 16, 2)->default(0.00);
            $table->text('keterangan')->nullable();
            $table->bigInteger('tanggalhistory')->default(0);
            ...
            $table->bigInteger('keuangan_id')->default(0);
            $table->bigInteger('keuangan_tgl')->default(0);
            $table->boolean('prepublish')->default(0);
            $table->boolean('aktif')->default(1);
            $table->bigInteger('tglnonaktif')->default(0);
            $table->string('alasannonaktif', 16)->nullable();
            $table->text('ketnonaktif')->nullable();
            $table->bigInteger('lama_garansi')->nullable();
            $table->string('kartu_garansi')->nullable();
            $table->boolean('status')->default(1);
            $table->boolean('peminjaman')->default(0);
            $table->boolean('perbaikan')->default(1);
            $table->timestamps();
        });
        ...
        Schema::create('history', function (Blueprint $table) {
            ...
            $table->foreignId('lokasi_id')->nullable()->constrained('lokasi')->onDelete('set null');
            $table->decimal('jumlah', 16, 2)->default(1.00);
            $table->bigInteger('kondisi')->default(100);
            $table->bigInteger('kelengkapan')->default(100);
            $table->text('keterangan')->nullable();
            $table->boolean('status')->default(1);
            $table->timestamps();
        });
        ...
        //     $table->bigInteger('stok_sisa')->default(0);
        //     $table->timestamps();
        // });
        ...
        Schema::create('diskon', function (Blueprint $table) {
            ...
            $table->bigInteger('persen')->default(0);
            $table->text('keterangan')->nullable();
            $table->bigInteger('dipakai')->default(0);
            $table->bigInteger('expired')->default(0);
            $table->boolean('aktif')->default(1);
            $table->timestamps();
        });
        ...
        Schema::create('harga', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('paket')->default(0);
            $table->bigInteger('bulan')->default(0);
        ...
        Schema::create('konfirmasi', function (Blueprint $table) {
            ...
            $table->bigInteger('paket')->default(0);
            $table->bigInteger('bulan')->default(12);
            $table->bigInteger('tanggal')->default(0);
        ...
        Schema::create('order', function (Blueprint $table) {
            ...
            $table->bigInteger('bulan')->default(0);
            $table->bigInteger('harga')->default(0);
            $table->bigInteger('angka_unik')->default(0);
            $table->string('diskon_kode', 128)->nullable();
            $table->bigInteger('diskon_persen')->default(0);
            $table->bigInteger('diskon_rp')->default(0);
