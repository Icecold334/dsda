...
class DriverSecuritySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $drivers = [
            ...
            [
                'nama' => 'Cakra Bagus Jati',
                'nopol' => null,
                'wilayah' => 'Jakarta Utara'
            ],
            [
                'nama' => 'Abdul Rahman Sini Suka',
                'nopol' => null,
                'wilayah' => 'Jakarta Utara'
            ],
            [
