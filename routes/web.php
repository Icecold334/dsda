...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('kategori/{tipe}/{kategori}', [KategoriController::class, 'create'])->middleware('can:gudang.read');
    Route::resource('kategori', KategoriController::class)->middleware('can:gudang.create,gudang.read,gudang.update,gudang.delete');
    Route::resource('keuangan', KeuanganController::class);
    Route::resource('lampiran', LampiranController::class);
    Route::get('lokasi/{tipe}/{lokasi}', [LokasiController::class, 'create'])->middleware('can:gudang.read');
    Route::resource('lokasi', LokasiController::class)->middleware('can:gudang.create,gudang.read,gudang.update,gudang.delete');
    Route::get('merk/{tipe}/{merk}', [MerkController::class, 'create'])->middleware('can:gudang.read');
    Route::resource('merk', MerkController::class)->middleware('can:gudang.create,gudang.read,gudang.update,gudang.delete');
    Route::get('ruang/{tipe}/{ruang}', [RuangController::class, 'create'])->middleware('can:gudang.read');
    Route::resource('ruang', RuangController::class)->middleware('can:gudang.create,gudang.read,gudang.update,gudang.delete');
    Route::get('person/{tipe}/{person}', [PersonController::class, 'create'])->middleware('can:manajemen_user.read');
    Route::resource('person', PersonController::class)->middleware('can:manajemen_user.create,manajemen_user.read,manajemen_user.update,manajemen_user.delete');
    Route::get('unit-kerja/{tipe}', [UnitKerjaController::class, 'create'])->middleware('can:gudang.read');
    Route::get('unit-kerja/{tipe}/{id}', [UnitKerjaController::class, 'create'])->middleware('can:gudang.read');
    Route::resource('unit-kerja', UnitKerjaController::class)->middleware('can:gudang.create,gudang.read,gudang.update,gudang.delete');
